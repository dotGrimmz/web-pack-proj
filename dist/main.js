...
const getSetup = async () => {
  let res = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(
    "https://v2.jokeapi.dev/joke/Programming?type=twopart"
  );
  console.log(res.data);
  jokeToTell.innerHTML = res.data.setup;
